...
- the <b>R scripts</b> which reproduce our complete analysis and resulting plots. The results won't be exactly the same, as in the article we used additional data on species occurrence which should be obtained directly from their original sources upon acceptance of their conditions.

A link to the article will be provided here when it is published.
